...
const create = async (
  ...
  if(typeof publicPost != "boolean") throw "Error: publicPost input is not a boolean";
  dateDue = validation.checkString(dateDue, "Date Due");
  timeDue = validation.checkString(timeDue, "Time Due");
  if(typeof durationH != "number" ||
     typeof durationM != "number" 
  ...
  //TODO: Need to return the inserted user by creating a getID function
};
